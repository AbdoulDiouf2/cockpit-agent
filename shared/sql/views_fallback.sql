...
-- Variantes minimales pour bases Sage 100 très anciennes ou atypiques.
-- Activé si detector.js ne reconnaît ni v21+ ni v15v17.
-- Les vues retournent les données disponibles avec un maximum de NULL safety.
-- =============================================================================
...
SELECT
    ...
    NULL                                            AS Valeur_Stock,          -- champ inconnu
    NULL                                            AS PMP,
